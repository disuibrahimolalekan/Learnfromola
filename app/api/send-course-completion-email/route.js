...
export async function POST(request) {
  ...
  const result = await sendBrevoEmail({
    ...
    textContent: [
      ...
      "You went from understanding what software even is, to planning with AI instead of just prompting blindly. That's a huge leap, and most people who start a course like this never finish it. You did.",
    ...
    htmlContent: [
      ...
      "<p>You went from understanding what software even is, to planning with AI instead of just prompting blindly. That's a huge leap, and most people who start a course like this never finish it. You did.</p>",
      "<p>So, what are you building next?</p>",
      "<p>Either way, go build something</p>",
      "<p>I look forward to seeing what you create. Good luck.</p>",
